...
from config import DATA_DIR, NUM_OF_INPUT, TEST_DONE_COLS, TEST_DONE_FILE, RTOL, ATOL
                                ...
                                if rule == "rule_15" or rule == "rule_16":
                                    ...
                                    if output_1 is not None and output_2 is not None:
                                        if lib == "tensorflow":
                                            ...
                                            if not np.allclose(output_1, output_2, rtol=RTOL, atol=ATOL):
                                            ...
                                            if not np.allclose(metrics_value_1, metrics_value_2, rtol=RTOL, atol=ATOL):
                                            ...
                                            for key in state_dict_1.keys():
                                                ...
                                                if not np.allclose(w1_np, w2_np, rtol=RTOL, atol=ATOL):
