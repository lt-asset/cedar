...
class FuzzerConfig:
    ...
    def generation_order(self): 
        ...
        try:
            util.DEBUG("Generation order: %s" % (list(nx.algorithms.dag.topological_sort(DG))))
